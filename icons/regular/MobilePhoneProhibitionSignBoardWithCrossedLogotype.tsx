/**
 * Original name: Mobile phone prohibition sign board with crossed logotype Icon Free Download
 */
export function MobilePhoneProhibitionSignBoardWithCrossedLogotype({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
  return (
    ...
    >
      <path d="m13.43 11.32c-.192 0-.384-.073-.53-.22-.293-.293-.293-.768 0-1.061l8.14-8.139c.293-.293.768-.293 1.061 0s.293.768 0 1.061l-8.141 8.139c-.147.147-.338.22-.53.22z" />
