/**
 * Original name: reply all arrows Icon Free Download
 */
export function ReplyAllArrows({ size = 24 }: { size?: number }): JSX.Element {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="m9.5 20c-.185 0-.369-.068-.515-.204l-8.75-8.25c-.15-.142-.235-.339-.235-.546s.085-.404.235-.546l8.75-8.25c.301-.283.776-.27 1.061.031.284.302.27.776-.031 1.061l-8.171 7.704 8.171 7.704c.301.284.315.759.031 1.061-.148.156-.347.235-.546.235z" />
    </svg>
  );
}
