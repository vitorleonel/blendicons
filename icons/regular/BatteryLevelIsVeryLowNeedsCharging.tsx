/**
 * Original name: Battery level is very low, needs charging. Icon Free Download
 */
export function BatteryLevelIsVeryLowNeedsCharging({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
  return (
    ...
    >
      <path
        d="M5.5,19c-0.339,0-0.646-0.231-0.729-0.575l-3-12.5C1.674,5.522,1.922,5.117,2.325,5.021
	c0.401-0.098,0.808,0.152,0.904,0.555l3,12.5c0.097,0.402-0.152,0.808-0.555,0.904C5.616,18.994,5.557,19,5.5,19z"
      />
      <path
