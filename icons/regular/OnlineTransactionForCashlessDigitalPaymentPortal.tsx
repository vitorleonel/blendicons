/**
 * Original name: online transaction for cashless digital payment portal Icon Free Download
 */
export function OnlineTransactionForCashlessDigitalPaymentPortal({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
