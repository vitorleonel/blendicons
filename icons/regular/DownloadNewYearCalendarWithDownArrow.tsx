/**
 * Original name: Download new year calendar with down arrow Icon Free Download
 */
export function DownloadNewYearCalendarWithDownArrow({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
    ...
    >
      <g id="Layer_1" display="none">
        ...
        <g display="inline">
          <path
            fill="#607D8B"
            d="M12,19.25c-0.552,0-1-0.448-1-1V12c0-0.552,0.448-1,1-1s1,0.448,1,1v6.25C13,18.802,12.552,19.25,12,19.25
			z"
          />
        </g>
        <g display="inline">
          <path
            fill="#607D8B"
            d="M15.938,16.45c0.118,0.273,0.065,0.592-0.138,0.811l-3.25,3.5C12.408,20.913,12.209,21,12,21
			s-0.408-0.087-0.55-0.239l-3.25-3.5C8.069,17.119,8,16.936,8,16.75c0-0.102,0.021-0.203,0.062-0.3C8.182,16.177,8.452,16,8.75,16
			h6.5C15.549,16,15.819,16.177,15.938,16.45z"
          />
        </g>
      </g>
      ...
      <g id="Layer_3">
        ...
        <g>
          <path
            d="M12,21c-0.192,0-0.384-0.073-0.53-0.22l-3.75-3.75c-0.293-0.293-0.293-0.768,0-1.061s0.768-0.293,1.061,0l3.22,3.22
			l3.22-3.22c0.293-0.293,0.768-0.293,1.061,0s0.293,0.768,0,1.061l-3.75,3.75C12.384,20.927,12.192,21,12,21z"
          />
        </g>
        <g>
          <path
