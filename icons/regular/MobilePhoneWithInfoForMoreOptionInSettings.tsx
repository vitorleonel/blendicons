/**
 * Original name: Mobile phone with info for more option in settings Icon Free Download
 */
export function MobilePhoneWithInfoForMoreOptionInSettings({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
  return (
    ...
    >
      ...
      <path d="m17.5 10c-.414 0-.75-.336-.75-.75v-3.5c0-.414.336-.75.75-.75s.75.336.75.75v3.5c0 .414-.336.75-.75.75z" />
      <circle cx="17.5" cy="3.75" r=".75" />
