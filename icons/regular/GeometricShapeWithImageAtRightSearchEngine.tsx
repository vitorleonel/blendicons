/**
 * Original name: Geometric shape with image at right - search engine Icon Free Download
 */
export function GeometricShapeWithImageAtRightSearchEngine({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
      ...
      <g>
        ...
        <g>
          <path
			...
			l0.521,0.521c0.062,0.062,0.142,0.069,0.18,0.068c0.042-0.002,0.123-0.017,0.187-0.093l1.025-1.235
			...
			c-0.493,0.045-0.961-0.163-1.304-0.505l-0.521-0.521c-0.097-0.098-0.262-0.098-0.359,0l-2.04,2.04
