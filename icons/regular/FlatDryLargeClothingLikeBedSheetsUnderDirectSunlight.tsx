/**
 * Original name: Flat dry large clothing like bed sheets under direct sunlight Icon Free Download
 */
export function FlatDryLargeClothingLikeBedSheetsUnderDirectSunlight({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
