/**
 * Original name: Unlocked and accessible cloud storage. Icon Free Download
 */
export function UnlockedAndAccessibleCloudStorage({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
  return (
    ...
    >
      <g fill="#000" fill-rule="evenodd">
        ...
        <path d="M9.75,10.5c0,-1.51878 1.2312,-2.75 2.75,-2.75h1c0.4142,0 0.75,0.33579 0.75,0.75c0,0.41421 -0.3358,0.75 -0.75,0.75h-1c-0.6904,0 -1.25,0.55964 -1.25,1.25v1c0,0.4142 -0.3358,0.75 -0.75,0.75c-0.4142,0 -0.75,-0.3358 -0.75,-0.75v-1Z"></path>
      </g>
    </svg>
  );
}
