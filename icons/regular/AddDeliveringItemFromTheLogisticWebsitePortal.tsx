/**
 * Original name: Add delivering item from the logistic website portal Icon Free Download
 */
export function AddDeliveringItemFromTheLogisticWebsitePortal({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
