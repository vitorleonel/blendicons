/**
 * Original name: maximize box button for an software application Icon Free Download
 */
export function MaximizeBoxButtonForAnSoftwareApplication({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
  return (
    ...
    >
      ...
      <path d="m23.25 24h-6.5c-.414 0-.75-.336-.75-.75s.336-.75.75-.75h5.75v-5.75c0-.414.336-.75.75-.75s.75.336.75.75v6.5c0 .414-.336.75-.75.75z" />
