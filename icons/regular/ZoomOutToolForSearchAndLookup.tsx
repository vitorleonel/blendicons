/**
 * Original name: Zoom out tool for search and lookup Icon Free Download
 */
export function ZoomOutToolForSearchAndLookup({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
  return (
    ...
    >
      ...
      <g>
        <path
          d="M13.25,10.25h-7.5C5.336,10.25,5,9.914,5,9.5s0.336-0.75,0.75-0.75h7.5C13.664,8.75,14,9.086,14,9.5
		S13.664,10.25,13.25,10.25z"
        />
      </g>
    </svg>
  );
