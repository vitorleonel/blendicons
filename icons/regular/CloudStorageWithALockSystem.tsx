/**
 * Original name: Cloud storage with a lock system. Icon Free Download
 */
export function CloudStorageWithALockSystem({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
  return (
    ...
    >
      <g fill="#000" fill-rule="evenodd">
        ...
        <path d="M8.75,11.5c0,-0.4142 0.33579,-0.75 0.75,-0.75h5c0.4142,0 0.75,0.3358 0.75,0.75v4c0,0.4142 -0.3358,0.75 -0.75,0.75h-5c-0.41421,0 -0.75,-0.3358 -0.75,-0.75v-4Zm1.5,0.75v2.5h3.5v-2.5h-3.5Z"></path>
        <path d="M9.75,10c0,-1.24264 1.0074,-2.25 2.25,-2.25c1.2426,0 2.25,1.00736 2.25,2.25v1.5c0,0.4142 -0.3358,0.75 -0.75,0.75h-3c-0.4142,0 -0.75,-0.3358 -0.75,-0.75v-1.5Zm2.25,-0.75c-0.4142,0 -0.75,0.33579 -0.75,0.75v0.75h1.5v-0.75c0,-0.41421 -0.3358,-0.75 -0.75,-0.75Z"></path>
      </g>
    </svg>
  );
}
