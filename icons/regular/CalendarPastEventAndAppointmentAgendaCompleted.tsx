/**
 * Original name: Calendar past event and appointment agenda completed Icon Free Download
 */
export function CalendarPastEventAndAppointmentAgendaCompleted({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
    ...
    >
      <g id="Layer_1" display="none">
        ...
        <g display="inline">
          <path
            fill="#42A5F5"
            d="M11,20c-0.025,0-0.051-0.001-0.076-0.003c-0.291-0.022-0.558-0.17-0.73-0.406l-2.75-3.75
			c-0.326-0.445-0.23-1.071,0.215-1.398s1.071-0.23,1.398,0.215l2.061,2.81l4.926-4.926c0.391-0.391,1.023-0.391,1.414,0
			s0.391,1.023,0,1.414l-5.75,5.75C11.519,19.896,11.264,20,11,20z"
          />
        </g>
      </g>
      ...
      <g id="Layer_3">
        <g>
          <path
            d="M11,19.75c-0.019,0-0.038,0-0.057-0.002c-0.218-0.017-0.418-0.128-0.548-0.305l-2.75-3.75
			C7.4,15.359,7.473,14.89,7.807,14.645c0.333-0.244,0.803-0.172,1.048,0.162l2.233,3.045l5.132-5.132
			c0.293-0.293,0.768-0.293,1.061,0s0.293,0.768,0,1.061l-5.75,5.75C11.389,19.671,11.198,19.75,11,19.75z"
          />
        </g>
        <g>
          <path
