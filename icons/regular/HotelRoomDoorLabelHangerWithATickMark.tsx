/**
 * Original name: Hotel room door label hanger with a tick mark Icon Free Download
 */
export function HotelRoomDoorLabelHangerWithATickMark({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
  return (
    ...
    >
      <g fill="#000" fill-rule="evenodd">
        ...
        <path d="M14.9801,13.4239c0.3182,0.2651 0.3612,0.738 0.0961,1.0563l-2.5,3c-0.1349,0.1618 -0.3317,0.2595 -0.5422,0.269c-0.2105,0.0096 -0.4153,-0.0698 -0.5643,-0.2189l-2.00003,-2c-0.29289,-0.2928 -0.29289,-0.7677 0,-1.0606c0.29289,-0.2929 0.76773,-0.2929 1.06063,0l1.4193,1.4193l1.9742,-2.3691c0.2652,-0.3182 0.7381,-0.3612 1.0563,-0.096Z"></path>
      </g>
    </svg>
  );
}
