/**
 * Original name: Unloading of an item up arrow navigation Icon Free Download
 */
export function UnloadingOfAnItemUpArrowNavigation({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
  return (
    ...
    >
      ...
      <path d="m20.25 19c-.181 0-.36-.064-.505-.195l-2.245-2.041-2.245 2.042c-.308.278-.781.256-1.06-.051-.279-.306-.256-.781.05-1.06l2.75-2.5c.287-.26.723-.26 1.01 0l2.75 2.5c.306.279.329.753.05 1.06-.148.162-.351.245-.555.245z" />
