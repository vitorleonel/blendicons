/**
 * Original name: Loading shipping items in cargo truck with up sign Icon Free Download
 */
export function LoadingShippingItemsInCargoTruckWithUpSign({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
  return (
    ...
    >
      <path
        d="M9.5,8.25c-0.192,0-0.384-0.073-0.53-0.22L6.5,5.561L4.03,8.03c-0.293,0.293-0.768,0.293-1.061,0s-0.293-0.768,0-1.061l3-3
	c0.293-0.293,0.768-0.293,1.061,0l3,3c0.293,0.293,0.293,0.768,0,1.061C9.884,8.177,9.692,8.25,9.5,8.25z"
      />
      <path
