/**
 * Original name: Upload and share calendar appointments to work group Icon Free Download
 */
export function UploadAndShareCalendarAppointmentsToWorkGroup({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
    ...
    >
      <g id="Layer_1" display="none">
        ...
        <g display="inline">
          <path
            fill="#607D8B"
            d="M12,21c-0.553,0-1-0.448-1-1v-6.25c0-0.552,0.447-1,1-1s1,0.448,1,1V20C13,20.552,12.553,21,12,21z"
          />
        </g>
        <g display="inline">
          <path
            fill="#607D8B"
            d="M15.938,15.55c0.118-0.273,0.065-0.592-0.138-0.811l-3.25-3.5C12.408,11.087,12.209,11,12,11
			s-0.408,0.087-0.55,0.239l-3.25,3.5C8.069,14.881,8,15.064,8,15.25c0,0.102,0.021,0.203,0.062,0.3C8.182,15.823,8.452,16,8.75,16
			h6.5C15.549,16,15.819,15.823,15.938,15.55z"
          />
        </g>
      </g>
      ...
      <g id="Layer_3">
        <g>
          <path
            d="M12,21c-0.414,0-0.75-0.336-0.75-0.75v-8.5c0-0.414,0.336-0.75,0.75-0.75s0.75,0.336,0.75,0.75v8.5
			C12.75,20.664,12.414,21,12,21z"
          />
        </g>
        <g>
          <path
            d="M15.75,16.25c-0.192,0-0.384-0.073-0.53-0.22L12,12.811l-3.22,3.22c-0.293,0.293-0.768,0.293-1.061,0
			s-0.293-0.768,0-1.061l3.75-3.75c0.293-0.293,0.768-0.293,1.061,0l3.75,3.75c0.293,0.293,0.293,0.768,0,1.061
			C16.134,16.177,15.942,16.25,15.75,16.25z"
          />
        </g>
        <g>
          <path
