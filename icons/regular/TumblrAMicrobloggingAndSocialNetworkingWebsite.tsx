/**
 * Original name: Tumblr a microblogging and social networking website Icon Free Download
 */
export function TumblrAMicrobloggingAndSocialNetworkingWebsite({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
