/**
 * Original name: Package box ready for delivering Icon Free Download
 */
export function PackageBoxReadyForDelivering({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
  return (
    ...
    >
      <g fill="#000" fill-rule="evenodd">
        ...
        <path d="M14.25,16.5c0,-0.4142 0.3358,-0.75 0.75,-0.75h4c0.4142,0 0.75,0.3358 0.75,0.75c0,0.4142 -0.3358,0.75 -0.75,0.75h-4c-0.4142,0 -0.75,-0.3358 -0.75,-0.75Z"></path>
      </g>
    </svg>
  );
}
