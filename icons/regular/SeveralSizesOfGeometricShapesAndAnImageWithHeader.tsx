/**
 * Original name: Several sizes of geometric shapes and an image with header Icon Free Download
 */
export function SeveralSizesOfGeometricShapesAndAnImageWithHeader({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
  return (
    ...
    >
      ...
      <g>
		...
		l0.521,0.521c0.062,0.062,0.138,0.067,0.18,0.068c0.042-0.002,0.123-0.017,0.187-0.093l1.025-1.235
		...
		c-0.488,0.039-0.961-0.163-1.304-0.505L3.679,17.49c-0.097-0.098-0.262-0.098-0.359,0l-2.04,2.04
