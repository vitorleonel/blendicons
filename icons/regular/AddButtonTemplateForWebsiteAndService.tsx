/**
 * Original name: Add button template for website and service Icon Free Download
 */
export function AddButtonTemplateForWebsiteAndService({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
  return (
    ...
    >
      ...
      <g>
        <path
          d="M12,18c-0.414,0-0.75-0.336-0.75-0.75V6.75C11.25,6.336,11.586,6,12,6s0.75,0.336,0.75,0.75v10.5
