/**
 * Original name: Discover offers reward credit cards and online banking Icon Free Download
 */
export function DiscoverOffersRewardCreditCardsAndOnlineBanking({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
