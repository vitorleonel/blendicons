/**
 * Original name: Square box template design isolated on white background Icon Free Download
 */
export function SquareBoxTemplateDesignIsolatedOnWhiteBackground({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
