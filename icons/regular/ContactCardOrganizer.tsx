/**
 * Original name: contact card organizer Icon Free Download
 */
export function ContactCardOrganizer({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
