/**
 * Original name: No entry and do not disturb section for the hotel room privacy Icon Free Download
 */
export function NoEntryAndDoNotDisturbSectionForTheHotelRoomPrivacy({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
  return (
    ...
    >
      <g fill="#000" fill-rule="evenodd">
        ...
        <path d="M14.6517,13.3484c0.2929,0.2929 0.2929,0.7678 0,1.0607l-4.2427,4.2426c-0.2929,0.2929 -0.76774,0.2929 -1.06063,0c-0.2929,-0.2928 -0.2929,-0.7677 0,-1.0606l4.24263,-4.2427c0.2929,-0.2928 0.7678,-0.2928 1.0607,0Z"></path>
      </g>
    </svg>
  );
}
