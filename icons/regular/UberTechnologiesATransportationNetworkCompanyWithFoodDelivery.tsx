/**
 * Original name: Uber Technologies a transportation network company with food delivery, Icon Free Download
 */
export function UberTechnologiesATransportationNetworkCompanyWithFoodDelivery({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
