/**
 * Original name: Representation of an article in modern format with picture and text Icon Free Download
 */
export function RepresentationOfAnArticleInModernFormatWithPictureAndText({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
