/**
 * Original name: Large size drawing board with pen tray Icon Free Download
 */
export function LargeSizeDrawingBoardWithPenTray({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
  return (
    ...
    >
      <g fill="#000" fill-rule="evenodd">
        ...
        <path d="M15.8029,16.2766c0.3996,-0.109 0.8119,0.1266 0.9209,0.5263l1.5,5.5c0.1089,0.3996 -0.1267,0.8119 -0.5263,0.9209c-0.3996,0.1089 -0.8119,-0.1267 -0.9209,-0.5263l-1.5,-5.5c-0.109,-0.3996 0.1266,-0.8119 0.5263,-0.9209Z"></path>
        <path d="M8.19715,16.2766c-0.39962,-0.109 -0.81192,0.1266 -0.92091,0.5263l-1.5,5.5c-0.10899,0.3996 0.12662,0.8119 0.52623,0.9209c0.39962,0.1089 0.81193,-0.1267 0.92091,-0.5263l1.5,-5.5c0.10899,-0.3996 -0.12661,-0.8119 -0.52623,-0.9209Z"></path>
      </g>
    </svg>
  );
}
