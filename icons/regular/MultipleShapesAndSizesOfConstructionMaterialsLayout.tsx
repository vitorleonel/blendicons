/**
 * Original name: Multiple shapes and sizes of construction materials layout Icon Free Download
 */
export function MultipleShapesAndSizesOfConstructionMaterialsLayout({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
