/**
 * Original name: The pound or pound-mass is a unit of mass used in the imperial Icon Free Download
 */
export function ThePoundOrPoundmassIsAUnitOfMassUsedInTheImperial({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
