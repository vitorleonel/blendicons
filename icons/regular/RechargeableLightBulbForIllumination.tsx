/**
 * Original name: Rechargeable light bulb for illumination. Icon Free Download
 */
export function RechargeableLightBulbForIllumination({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
  return (
    ...
    >
      ...
      <path
        className="cls-1"
        d="M8.75,8c.41,0,.75,.34,.75,.75v9.5c0,.41-.34,.75-.75,.75s-.75-.34-.75-.75V8.75c0-.41,.34-.75,.75-.75Z"
      />
      <path
        className="cls-1"
        d="M8,3.75c0-.41,.34-.75,.75-.75,3.18,0,5.75,2.57,5.75,5.75,0,.41-.34,.75-.75,.75s-.75-.34-.75-.75c0-2.35-1.9-4.25-4.25-4.25-.41,0-.75-.34-.75-.75Z"
      />
    </svg>
  );
}
