export function BMWIsAGermanMultinationalCompanyWhichProducesAutomobilesAndMotorcycles({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
      ...
      <g>
        <g>
          <g>
            <g>
              <path
                d="M12,20c-0.414,0-0.75-0.336-0.75-0.75V4.75C11.25,4.336,11.586,4,12,4s0.75,0.336,0.75,0.75v14.5
      ...
      <g>
        <g>
          <g>
            <g>
              <path
                d="M19.25,12.75H4.75C4.336,12.75,4,12.414,4,12s0.336-0.75,0.75-0.75h14.5c0.414,0,0.75,0.336,0.75,0.75
