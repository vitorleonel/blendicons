export function BackKeyNavigationButtonOnComputerButton({
  size = 24,
}: {
  size?: number;
}): JSX.Element {
  return (
    ...
    >
      <path d="m15.25 19c-.188 0-.374-.069-.52-.209l-6.5-6.25c-.147-.142-.23-.337-.23-.541s.083-.399.23-.541l6.5-6.25c.299-.286.773-.278 1.061.021.287.298.277.773-.021 1.061l-5.938 5.709 5.938 5.709c.299.287.309.763.021 1.061-.147.153-.344.23-.541.23z" />
